  ...
  return (
    <Container>
      <div className="flex items-center justify-between">
        ...
        >
          <Image src={MetarchLogo} className="h-12 w-[60%] lg:h-22 lg:w-full" />
          {/* <Logomark
    ...
    <MotionConfig transition={shouldReduceMotion ? { duration: 0 } : undefined}>
      <header>
        ...
        <motion.div
          ...
          className="relative z-50 overflow-hidden bg-[var(--bg)] pt-2"
          aria-hidden={expanded ? undefined : 'true'}
          inert={expanded ? undefined : ''}
        >
          <motion.div layout className="bg-[var(--bg)]">
            <div ref={navRef} className="bg-[var(--text)] pt-14 pb-16">
              <Header
                invert
                panelId={panelId}
                icon={XIcon}
      ...
      >
        ...
        >
          <GridPattern
            className="absolute inset-x-0 -top-14 -z-10 h-[1000px] w-full fill-[var(--textSoft)] stroke-[var(--bgSofter)] [mask-image:linear-gradient(to_bottom_left,white_40%,transparent_50%)]"
            yOffset={-96}
            interactive
          />
